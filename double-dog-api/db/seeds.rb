...
Dare.create(text: "lose a point", :points => -1, :shots=>1)
...
Dare.create(text: "Take the socks off the person’s feet across from you and wear them like gloves for the rest of the game", :points =>1, :shots=>3 )
